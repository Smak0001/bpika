<x-app-layout>
    <x-index-with-actions>
        <x-slot name="actions">
            <x-label style="font-size: xx-large; padding-top: 10px; color: black">{{ __('Code') }}</x-label><span style="font-size: x-large; padding-top: 10px; color: black">{{ $station->code }}</span>
            <x-label style="font-size: xx-large; padding-top: 10px; color: black">{{ __('Name') }}</x-label><span style="font-size: x-large; padding-top: 10px; color: black">{{ $station->name }}</span>
            <x-label style="font-size: xx-large; padding-top: 10px; color: black">{{ __('City') }}</x-label><span style="font-size: x-large; padding-top: 10px; color: black">{{ $station->city }}</span>
            <x-label style="font-size: xx-large; padding-top: 10px; color: black">{{ __('Timezone') }}</x-label><span style="font-size: x-large; padding-top: 10px; color: black">{{ $station->timezone }}</span>
            {{-- Divider --}}
            ...
            <x-label style="font-size: x-large; padding-top: 10px; color: deepskyblue">25 °C</x-label>
            <x-label style="font-size: xx-large; padding-top: 20px; color: blue">{{ __('Temperature') }}</x-label>
            <x-label style="font-size: x-large; padding-top: 10px; color: blue">{{ $station->measurements[0]->th_temp}} °C</x-label>
            <x-label style="font-size: xx-large; padding-top: 20px; color: darkblue">{{ __('Humidity') }}</x-label>
            <x-label style="font-size: x-large; padding-top: 10px; color: darkblue">{{ $station->measurements[0]->th_hum}}%</x-label>
            <x-label style="font-size: xx-large; padding-top: 20px; color: black">{{ __('Wind direction') }}:</x-label>
